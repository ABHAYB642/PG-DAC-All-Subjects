...
public class MyQueue {
         ...
         public MyQueue() {
        	 ...
        	 front=0;//array points to the first value in the queue
         ...
         public int dequeue() {
        	 if(isEmpty()) {
        		 System.out.println("Queue is empty,so can not delete the number...");
        		 return -1;
        	 }
        	 else
        	 {
		...
		public String toString() {
			return "MyQueue [queuearr=" + Arrays.toString(queuearr) + ", front=" + front + ", rear=" + rear + "]";
		}
